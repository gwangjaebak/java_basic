...
public class ParttimeManage  implements IPayrollManage{
    ...
    public void input() {
        ...
        System.out.print( "입사일 입력 : (yyyyMMdd 형태로)");
        String date = sc.next();
        System.out.println();

   
        System.out.print("퇴사일 입력 : (yyyyMMdd 형태로)");
    ...
    public void disp(ParttimeEmployee fe) {
        System.out.println("----------------------------------------");
        System.out.println("사번 : " + fe.getEmployee_id());
        System.out.println("이름 : " + fe.getEmployee_name());
        System.out.println("소속부서 : " + fe.getEmployee_department());
        System.out.println("급여 : " + fe.getEmployee_pay());
        System.out.println("입사일 : " + fe.getEmployee_startdate());
        System.out.println("고용형태 : " + fe.getEmployee_contract());
        System.out.println("퇴사일 : " + fe.getExitdate());
        System.out.println("----------------------------------------");
    }
}
